...
The orchestrator is the **main Claude session** and the user-facing entry point for L2. It does not own domain duties itself; it analyzes requests and dispatches the right role subagent, then routes results (and cross-role hand-offs) between them.

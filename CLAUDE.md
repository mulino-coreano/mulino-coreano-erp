...
| L2 | `agents/` | `cli/` (Zig `mulino` binary) + `skills/` (orchestrator / supply-chain / procurement / qc). Codex is the agent runtime; the orchestrator dispatches role subagents. See `agents/CLAUDE.md` |

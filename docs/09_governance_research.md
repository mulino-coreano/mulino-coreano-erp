...
- **알람 피로 문헌 활용 계획** (2026-08-30 인터뷰): P5 잠정 하한(40%)의 승인자 용량 측정은 LLM approval fatigue 논문보다 의료 알람 피로(alarm fatigue) 문헌에서 삼각측량한다 — 간호사가 알람에 기계적으로 반응하기 시작하는 역치의 실측 데이터가 오래되고 튼튼하다. 상세는 docs/08 §5 조사 계획.

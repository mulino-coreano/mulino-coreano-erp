...
class WaitingConditionMatcherTest {
    ...
    private static Stream<Arguments> matchingExamples() {
        return Stream.of(
                ...
                // A condition naming both supplier and PO needs both to match.
                Arguments.of("SUPPLIER_REPLY", "{\"supplier_id\":3,\"po_ref\":\"PO-104\"}",
                        "SUPPLIER_EMAIL_RECEIVED", "{\"supplierId\":3,\"poRef\":\"PO-200\"}", false),
                Arguments.of("SUPPLIER_REPLY", "{\"supplier_id\":3,\"po_ref\":\"PO-104\"}",
                        "SUPPLIER_EMAIL_RECEIVED", "{\"supplierId\":4,\"poRef\":\"PO-104\"}", false),
                Arguments.of("SUPPLIER_REPLY", "{\"supplier_id\":3,\"po_ref\":\"PO-104\"}",
                        "SUPPLIER_EMAIL_RECEIVED", "{\"supplierId\":3}", false),
                Arguments.of("SUPPLIER_REPLY", "{\"supplier_id\":3,\"po_ref\":\"PO-104\"}",
                        "SUPPLIER_EMAIL_RECEIVED", "{\"supplierId\":3,\"poRef\":\"PO-104\"}", true),
                Arguments.of("SUPPLIER_REPLY", "{\"supplier_id\":42}",
